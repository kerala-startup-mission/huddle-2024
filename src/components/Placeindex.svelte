<script>
 ...
 <div id="default-carousel" class=" relative w-full" data-carousel="slide">
    ...
    <div class="relative gap-4 h-[450px] overflow-hidden rounded-lg">
         <!-- Item 1 -->
         <a href="/nearby_attractions" target="_blank">
            <h1 class=" text-white p-4 font-semibold">Nearby Attractions</h1>
        </a>
         {#each locations as location, index}
            <div class="hidden duration-700 px-4 ease-in-out md:w-1/2 h-full" data-carousel-item>
                ...
                <div class=" absolute bottom-6 left-0  bg-opacity-80 p-4 pb-0 w-full">
                    <h2 class="text-lg text-white font-semibold">{location.title}</h2>
