  ...
  <div class="w-full container mx-auto  flex justify-between px-4">
   ...
   <main class=" flex  items-start px-16 my-auto">
      <div class="flex my-auto "style="font-family: Museo-Sans, sans-serif;">
          ...
          <a href="/#investors" class="md:flex cursor-pointer hidden px-4 py-3  md:py-1 uppercase text-white group-hover:text-yellow-400  text-sm">Investors</a>
          <a href="/#mentors"  class="md:flex cursor-pointer hidden px-4 py-3  md:py-1 uppercase text-white group-hover:text-yellow-400  text-sm">Mentors</a>
      ...
      <div class="mb-8  font-medium sm:bg-transparent p-5 sm:p-0 rounded-md flex items-center justify-center">
       ...
       <nav>
          <ul class=" md:text-sm gap-2 font-data">
                  ...
                  <li on:click="{()=> menu_open = !menu_open }" class="px-5 py-2 transform hover:bg-gray-400 transition duration-500 hover:scale-100 md:hidden flex">
                    <a href="/#investors"   class="md:text-white cursor-pointer text-white font-bold hover:text-black uppercase ">Investors</a>
                  </li>

                  <li on:click="{()=> menu_open = !menu_open }" class="px-5 py-2 transform hover:bg-gray-400 transition duration-500 hover:scale-100 md:hidden flex">
                    <a href="/#mentors"   class="md:text-white cursor-pointer text-white font-bold hover:text-black uppercase ">Mentors</a>
                  </li>
